...
(assert (= BL_947_then_12 (=> (= _JML___exception_947_947___1 NULL) (=> (forall ((QTHIS REF) ) (=> (and (distinct QTHIS NULL) (and (distinct QTHIS NULL) (javaSubType (javaTypeOf QTHIS) T_fr_amossys_optet_example_sensitivedata_SensitiveData))) (= (fr_amossys_optet_example_sensitivedata_SensitiveData_getEncrypted_1452 _heap___0 QTHIS) (select encrypted_461 QTHIS)))) (=> (forall ((QTHIS REF) ) (= (_JML_METHODEF__fr_amossys_optet_example_sensitivedata_SensitiveData_getEncrypted_1452 _heap___0 QTHIS) (and (distinct QTHIS NULL) (and (distinct QTHIS NULL) (javaSubType (javaTypeOf QTHIS) T_fr_amossys_optet_example_sensitivedata_SensitiveData))))) (=> (= ASSERT_43_846_846___6 (or (not Pre_1_0_846___4) (_JML_METHODEF__fr_amossys_optet_example_sensitivedata_SensitiveData_getEncrypted_1452 _heap___0 THIS))) (and ASSERT_43_846_846___6 (=> ASSERT_43_846_846___6 (=> (= ASSERT_44_846_846___7 (or (not Pre_1_0_846___4) (fr_amossys_optet_example_sensitivedata_SensitiveData_getEncrypted_1452 _heap___0 THIS))) (and ASSERT_44_846_846___7 (=> ASSERT_44_846_846___7 BL_947_afterIf_11)))))))))))
;OUT: success

(assert (= BL_947_else_13 (=> (not (= _JML___exception_947_947___1 NULL)) (=> (= ASSERT_45_947_947___8 (or (not Pre_1_0_846___4) (or false (and (distinct _JML___exception_947_947___1 NULL) (javaSubType (javaTypeOf _JML___exception_947_947___1) T_java_lang_RuntimeException))))) (and ASSERT_45_947_947___8 (=> ASSERT_45_947_947___8 BL_947_afterIf_11))))))
;OUT: success

(assert (= BL_947_afterIf_11 (=> (= ASSERT_46_947_947___9 (distinct __JML_AssumeCheck_ 2)) (and ASSERT_46_947_947___9 (=> ASSERT_46_947_947___9 (and BL_947finallyNormal_9 BL_947finallyExit_10))))))
;OUT: success

(assert (= BL_947finallyNormal_9 (=> (= _JML___termination_947_947___2 0) BL_947_AfterTry_4)))
;OUT: success

(assert (= BL_947finallyExit_10 (=> (distinct _JML___termination_947_947___2 0) BL_947_AfterTry_4)))
;OUT: success

(assert (= BL_947_AfterTry_4 true))
;OUT: success

(assert (not BL_947Start_1))
;OUT: success
...
(get-value ( Pre_1_0_846___4))
;OUT: ((Pre_1_0_846___4 true))
...
;OUT: (((fr_amossys_optet_example_sensitivedata_SensitiveData_getEncrypted_1452 _heap___0 THIS) false))

(get-value ( _heap___0))
;OUT: ((_heap___0 5))

(get-value ( (not Pre_1_0_846___4)))
;OUT: (((not Pre_1_0_846___4) false))

(get-value ( (or (not Pre_1_0_846___4) (fr_amossys_optet_example_sensitivedata_SensitiveData_getEncrypted_1452 _heap___0 THIS))))
;OUT: (((or (not Pre_1_0_846___4) (fr_amossys_optet_example_sensitivedata_SensitiveData_getEncrypted_1452 _heap___0 THIS)) false))
...
(get-value ( (or false (and (distinct _JML___exception_947_947___1 NULL) (javaSubType (javaTypeOf _JML___exception_947_947___1) T_java_lang_RuntimeException)))))
;OUT: (((or false (and (distinct _JML___exception_947_947___1 NULL) (javaSubType (javaTypeOf _JML___exception_947_947___1) T_java_lang_RuntimeException))) false))

(get-value ( QTHIS))
;OUT: (error "line 538 column 13: unknown constant QTHIS")

(get-value ( _JML___exception_947_947___1))
;OUT: ((_JML___exception_947_947___1 REF!val!18))

(get-value ( (distinct __JML_AssumeCheck_ 1)))
;OUT: (((distinct __JML_AssumeCheck_ 1) true))

(get-value ( QTHIS))
;OUT: (error "line 541 column 13: unknown constant QTHIS")
...
(get-value ( (or (not Pre_1_0_846___4) (or false (and (distinct _JML___exception_947_947___1 NULL) (javaSubType (javaTypeOf _JML___exception_947_947___1) T_java_lang_RuntimeException))))))
;OUT: (((or (not Pre_1_0_846___4) (or false (and (distinct _JML___exception_947_947___1 NULL) (javaSubType (javaTypeOf _JML___exception_947_947___1) T_java_lang_RuntimeException)))) false))

(get-value ( 1))
;OUT: ((1 1))

(get-value ( (and (distinct _JML___exception_947_947___1 NULL) (javaSubType (javaTypeOf _JML___exception_947_947___1) T_java_lang_RuntimeException))))
;OUT: (((and (distinct _JML___exception_947_947___1 NULL) (javaSubType (javaTypeOf _JML___exception_947_947___1) T_java_lang_RuntimeException)) false))
...
;OUT: (error "line 550 column 28: unknown constant QTHIS")

(get-value ( QTHIS))
;OUT: (error "line 551 column 13: unknown constant QTHIS")

(get-value ( (distinct QTHIS NULL)))
;OUT: (error "line 552 column 23: unknown constant QTHIS")

(get-value ( QTHIS))
;OUT: (error "line 553 column 13: unknown constant QTHIS")
...
;OUT: (error "line 556 column 95: unknown constant QTHIS")

(get-value ( THIS))
;OUT: ((THIS REF!val!0))

(get-value ( (or (not Pre_1_0_846___4) (_JML_METHODEF__fr_amossys_optet_example_sensitivedata_SensitiveData_getEncrypted_1452 _heap___0 THIS))))
;OUT: (((or (not Pre_1_0_846___4) (_JML_METHODEF__fr_amossys_optet_example_sensitivedata_SensitiveData_getEncrypted_1452 _heap___0 THIS)) true))
...
;OUT: (error "line 559 column 28: unknown constant QTHIS")
...
(get-value ( BL_947Start_1))
;OUT: ((BL_947Start_1 false))

(get-value ( BL_957bodyBegin_2))
;OUT: ((BL_957bodyBegin_2 false))

(get-value ( BL_947_AfterLabel_3))
;OUT: ((BL_947_AfterLabel_3 false))

(get-value ( ASSERT_40_947_947___5))
;OUT: ((ASSERT_40_947_947___5 true))

(get-value ( BL_947tryTarget_5))
;OUT: ((BL_947tryTarget_5 false))

(get-value ( BL_947noException_7))
;OUT: ((BL_947noException_7 false))

(get-value ( BL_947_finally_6))
;OUT: ((BL_947_finally_6 false))

(get-value ( BL_947_then_12))
;OUT: ((BL_947_then_12 false))

(get-value ( ASSERT_43_846_846___6))
;OUT: ((ASSERT_43_846_846___6 true))

(get-value ( ASSERT_44_846_846___7))
;OUT: ((ASSERT_44_846_846___7 false))

(pop 1)
;OUT: success

(assert ASSERT_44_846_846___7)
;OUT: success
